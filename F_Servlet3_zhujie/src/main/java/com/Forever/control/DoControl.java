...
public class DoControl extends HttpServlet {
	...
	/*	String action=request.getParameter("action");
		...
		if(action.equals(FIRST)){
			dispatcher=request.getRequestDispatcher(map.get(FIRST).toString());
		}else if(action.equals(SECOND)){
			dispatcher=request.getRequestDispatcher(map.get(SECOND).toString());
		}
